...
func (hs *HTTPServer) registerRoutes() {
	...
	r.Group("/api", func(apiRoute routing.RouteRegister) {
		...
		apiRoute.Group("/org", func(orgRoute routing.RouteRegister) {
			...
			// prefs
			orgRoute.Get("/preferences", authorize(reqOrgAdmin, ac.EvalPermission(ActionOrgsRead, ScopeOrgCurrentID)), routing.Wrap(GetOrgPreferences))
			orgRoute.Put("/preferences", authorize(reqOrgAdmin, ac.EvalPermission(ActionOrgsWrite, ScopeOrgCurrentID)), bind(dtos.UpdatePrefsCmd{}), routing.Wrap(UpdateOrgPreferences))
		})
		...
		apiRoute.Group("/orgs/:orgId", func(orgsRoute routing.RouteRegister) {
			...
			orgsRoute.Put("/quotas/:target", authorize(reqGrafanaAdmin, ac.EvalPermission(ActionOrgsWrite, ScopeOrgID)), bind(models.UpdateOrgQuotaCmd{}), routing.Wrap(hs.UpdateOrgQuota))
		})
